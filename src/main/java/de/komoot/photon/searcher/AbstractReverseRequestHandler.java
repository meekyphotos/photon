...
public abstract class AbstractReverseRequestHandler<R extends ReverseRequest> implements ReverseRequestHandler<R> {
  ...
  public AbstractReverseRequestHandler(final ElasticsearchReverseSearcher elasticsearchSearcher) {
  ...
  public List<JSONObject> handle(final R photonRequest) {
    ...
    final SearchResponse results = elasticsearchSearcher.search(queryBuilder.buildQuery(), photonRequest.getLimit(), photonRequest.getLocation(),
